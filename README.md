...
- 七位原创命名角色（绯岚/汀兰/疾风/铁岳/星眸/焰蝶/月绫），各有专属技能组与半身像
...
- 4800×2700 大世界，九大主题猎场（住宅区/闹区/后山/废车场/沙漠/雪山/城堡/宇宙船/天空之城，Lv1→Lv18 等级带）+ 草原、湖泊与水晶荒原，殖民舰/残堡/浮空尖塔三大地标
- 八个区域 Boss 阶梯（Lv7 棘颚兽 → Lv20 深红督军），独立 90 秒重生、击杀必掉稀有装备
- 装备属性预算随物品等级增长（上限 Lv20），后期装备大幅堆叠力量/敏捷/精神/体魄
- 每位角色三个技能：Q/E（可升至 10 级）+ F 大招（长冷却、大范围，可升至 5 级）
- 中央城镇安全区（免疫怪物伤害、加速恢复）、修复药剂（`R` 键饮用）
