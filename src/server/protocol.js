...
const WORLD_META = {
  ...
  marketListings: { $optional: { $array: {
    id: "string",
    seller: "string",
    item: {
      id: "string", slot: "string", rarity: "string", tier: "number", level: "number",
      name: "string", dropClass: "string?", refine: "number?",
    },
    price: "number",
    expiresAt: "number",
  } } },
...
const PLAYER_BASE = {
  ...
  // A camp decides who may shoot at whom in the battle zone, so it has to be
  // legible before the shot rather than after it.
  armyCamp: "string|null",
  attunement: "string",
...
export const PLAYER_SELF = {
  ...
  dew: "number",
  protections: "number",
  mailbox: { $array: { id: "string", kind: "string", from: "string", subject: "string", createdAt: "number", gold: "number", items: { $array: ITEM_FULL } } },
  marketListings: { $array: { id: "string", item: ITEM_FULL, price: "number", listedAt: "number", expiresAt: "number" } },
  // The roster the owner sees: every member, online or not.
  army: { $nullable: { name: "string", rank: "string", camp: "string|null", hall: { $nullable: { floor: "number", rentDueAt: "number" } }, members: { $array: { name: "string", rank: "string", online: "boolean", level: "number" } } } },
...
export const PROTOCOL = Object.freeze({
  ...
  clientMessages: {
    ...
    bankDeposit: { gold: "number" },
    bankWithdraw: { gold: "number" },
    mailSend: { target: "string", itemIds: { $array: "string" }, gold: "number", subject: "string?" },
    mailClaim: { mailId: "string" },
    marketList: { item: "string", price: "number" },
    marketBuy: { listingId: "string" },
    ...
    partyLeave: {},
    armyCreate: { name: "string", camp: "string?" },
    armySetCamp: { camp: "string" },
    armyRentHall: { floor: "number" },
    armyReleaseHall: {},
    armySiege: { camp: "string", floor: "number" },
  ...
  events: {
    ...
    bankDeposited: { playerId: "string", amount: "number", carriedGold: "number", bankGold: "number" },
    bankWithdrawn: { playerId: "string", amount: "number", carriedGold: "number", bankGold: "number" },
    mailSent: { playerId: "string", mailId: "string", target: "string", gold: "number", itemCount: "number" },
    mailReceived: { playerId: "string", mailId: "string", from: "string", gold: "number", itemCount: "number" },
    mailClaimed: { playerId: "string", mailId: "string", gold: "number", itemCount: "number" },
    marketListed: { playerId: "string", listingId: "string", itemId: "string", price: "number", expiresAt: "number" },
    marketSold: { playerId: "string", listingId: "string", itemId: "string", price: "number", tax: "number" },
    marketExpired: { playerId: "string", listingId: "string", itemId: "string" },
    ...
    armyCreated: { playerId: "string", name: "string", camp: "string|null" },
    armyCampSet: { playerId: "string", army: "string", camp: "string" },
    armyHallRented: { playerId: "string", army: "string", camp: "string", floor: "number", rent: "number" },
    armyHallRentPaid: { playerId: "string", army: "string", rent: "number", dueAt: "number" },
    armyHallLost: { playerId: "string", army: "string", floor: "number|null", reason: "string" },
    armySiegeStarted: { playerId: "string", army: "string", targetArmy: "string", targetCamp: "string", floor: "number", siegeId: "string", endsAt: "number" },
    armySiegeEnded: { siegeId: "string", army: "string", targetArmy: "string", targetCamp: "string", floor: "number", result: "string", reason: "string" },
    armyHallEvicted: { playerId: "string", army: "string", targetArmy: "string", targetCamp: "string", floor: "number" },
