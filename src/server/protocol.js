...
export const PLAYER_SELF = {
  ...
  army: { $nullable: { name: "string", rank: "string", camp: "string|null", members: { $array: { name: "string", rank: "string", online: "boolean", level: "number" } } } },
...
export const PROTOCOL = Object.freeze({
  ...
  errorCodes: [
    ...
    "ARMY_ACTIVE", "ARMY_FULL", "CAMP_SETTLED", "INVALID_CAMP", "ARMY_LEVEL_TOO_LOW", "ARMY_NAME_TAKEN",
