...
| T-029 | **P3 第四步 · 攻城**（实现方 = Codex，复核方 = Claude，**角色对调**） | **Review** | Codex | 已补成 30 秒攻防窗口：攻方统领持续驻守，守方 HQ 占位可守城并沿用战斗区 PvP；统领死亡/离位失败，无人防守完整窗口才驱逐；定向 20/20、全量 238/238 通过，回交 Claude |
